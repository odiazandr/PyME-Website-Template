...
| T2   | `docs/spec/operations-readiness.md`                          | Client operational readiness attestations and gate            |
...
| T3   | `docs/decisions/0115-operations-readiness-attestations.md`  | Why operational readiness is distinct from site deployability |
