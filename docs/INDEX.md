...
| `tests/` | Implemented memory, data, and route-contract verification; browser and accessibility suites are planned |
| `src/` | Implemented Astro, data, design, shared layout, components, and reference routes |
